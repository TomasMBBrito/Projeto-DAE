  ...
  <div class="tag-details">
        ...
        <div v-else class="publications-list">
          ...
          >
            ...
            <div class="publication-stats">
              <span>⭐ {{ pub.averageRating ? pub.averageRating.toFixed(1) : 'N/A' }}</span>
    ...
    <div v-if="showDeleteModal" class="modal-overlay" @click="cancelDelete">
      <div class="modal-content" @click.stop>
        ...
        <p class="warning">This will hide the tag from the system.</p>
        <div class="modal-actions">
          <button class="btn-cancel" @click="cancelDelete">Cancel</button>
          <button class="btn-delete-confirm" @click="executeDelete" :disabled="actionLoading">
...
async function executeDelete() {
  ...
  try {
    await tagStore.remove(tagId.value)
    router.push('/tags')
  } catch (e) {
